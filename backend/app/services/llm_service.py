...
def _system_prompt() -> str:
    return (
        ...
        "Keep the message short and mobile-friendly: ideally 1-2 short paragraphs. Answer the "
        "client's question directly first, then include only the most relevant policy or package "
        "details. For pricing or package questions, summarize only the main packages by name, "
        "price, and guest limit; do not list every add-on, overtime fee, or fine-print detail "
        ...
        "End with exactly one short follow-up sentence that fits the detected intent: pricing/package "
